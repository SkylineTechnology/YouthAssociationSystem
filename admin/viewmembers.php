                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                $memberId = ucfirst($row["member_id"]);
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $fname." ".$oname; ?></td>
                                                    <td><?php echo $gender; ?></td>
                                                    <td><?php echo $dob; ?></td>                                                   
                                                    <td><?php echo $phone; ?></td>
                                                    <td><?php echo $email; ?></td>
                                                    <td style="text-transform: uppercase;"><?php echo $qualification; ?></td>                                                   
                                                    <td><?php echo $state; ?></td>
                                                    <td><?php echo $lga; ?></td>                                                   
                                                    <td><?php echo $reg_date; ?></td>
                                                    <td><a href="../completeReg.php?m=<?php echo base64_encode($memberId); ?>">PROFILE</a></td>
                                                </tr>
                                                <?php
                                                $a++;
                                            }
