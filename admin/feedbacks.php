                                                ...
                                                <tbody>
                                                    ...
                                                    if ($msg_read_status == "") {
                                                        ...
                                                        while ($row = mysqli_fetch_array($get_feedbacks)) {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td><input title="select message to delete" name="contact_id[]" value="<?php echo $contactUs_id; ?>" type="checkbox" /></td>
                                                                ...
                                                                <td class = "mailbox-name"><a href = "read_mail.php?cid=<?php echo base64_encode($contactUs_id); ?>"><?php echo $fullname;
                                                                    ?></a></td>
