    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <!--  <li class="active treeview">
            ...
            <li class="active treeview">
                <a href="blog.php">
                    <i class="fa fa-share"></i> <span>Create Content</span>
                </a>
            </li>

            <li class="active treeview">
                <a href="blog_content.php">
                    <i class="fa fa-share"></i> <span>Manage Contents</span>
                </a>
            </li>

         <!--   <li class="active treeview">
                <a href="addqoutes.php">
                    <i class="fa fa-share"></i> <span>Add & Manage Quotes</span>
                </a>
            </li> -->
