...
<footer>
        ...
        <div class="row footer-gap">
            <div class="col-lg-3 col-sm-6">
                ...
                <address class="mb-0">
                    ...
                    <p><i class="fas fa-envelope-open"></i> <a href="www.aydecon.com.ng">www.aydecon.com.ng</a></p>
            ...
            <div class="col-lg-3 col-md-5 col-sm-6 mt-lg-0 mt-sm-5 mt-4 pr-md-5">
                ...
                <p class="mb-4">Subscribe to Our Newsletter to get our latest News and Events</p>
                <form action="" method="post">
                    <input type="email" name="email" placeholder="Enter your email..." required="">
                    <button type="submit" name="nlatter" class="btn1"><i class="far fa-paper-plane"></i></button>
    ...
    <div class="copyright pb-5 text-center">
        <p>© 2020. All Rights Reserved | Design by <a href="http://www.geemlatech.com" target="_blank">Geemla Technologies Ltd</a></p>
    </div>
</footer>